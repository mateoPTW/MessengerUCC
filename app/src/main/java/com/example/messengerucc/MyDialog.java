...
public class MyDialog extends DialogFragment {
    ...
    private Dialog getUpdateStudentDialog() {
        ...
        TextView title = view.findViewById(R.id.TittleDialog);
        title.setText("Actualizar estudiente");

        EditText roll_edt = view.findViewById(R.id.est01);
        EditText name_edt = view.findViewById(R.id.edt02);

        roll_edt.setHint("Lista");
        name_edt.setHint("Nombre");
    ...
    private Dialog getAddStudentDialog() {
        ...
        TextView title = view.findViewById(R.id.TittleDialog);
        title.setText("Añadir estudiente");
